...
class salesOrderPaymentRefund implements ObserverInterface {
    ...
    public function execute(\Magento\Framework\Event\Observer $observer) {
        ...
        $order = $objectManager->create('\Magento\Sales\Model\Order') ->load($orderId[0]);
            ...
            $objectManager->create('Thirdwatch\Mitra\Helper\Log')->log("salesOrderPaymentRefund");
            $objectManager->create('Thirdwatch\Mitra\Helper\Order')->postOrder($order, $objectManager->create('Thirdwatch\Mitra\Helper\Order')->ACTION_REFUND);
        }
    }
